...
import static com.tanguy.ee.blocks.ModBlocks.FIRSTBLOCK_CONTAINER;
...
public class FirstBlockContainer extends Container {
     ...
     * @param x X position
     * @param y Y position
     * @param amount Slot amount in the horizontal
     * @param dx Spacement between each slot on the X axis
     * @return
     */
     ...
     * @param x X position
     * @param y Y position
     * @param horAmount Slot amount in the horizontal
     * @param dx Spacement between each slot on the X axis
     * @param verAmount Slot amount in the Verical
     * @param dy Spacement between each slot on the Y axis
     * @return
     */
    ...
    /**
     * @param leftCol Left pixel index
     * @param topRow Top pixel index
     */
